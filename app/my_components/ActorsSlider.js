  ...
  const ActorSlider = () => {
    ...
    return (
      <div className='w-full md:h-screen max-md:h-[150vh] relative max-md:flex max-md:flex-col' id='Actores'>
        ...
        {/* Actor Info */}
        <div
          className='w-[60%] h-[90%] absolute top-1/2 right-0 transform -translate-y-1/2 flex flex-col md:justify-center items-start transition-opacity duration-1500 ease-in-out p-10 max-md:relative max-md:w-full max-md:h-[50%] md:px-20 max-md:p-4'
          style={{ opacity: 1 }}
        >
